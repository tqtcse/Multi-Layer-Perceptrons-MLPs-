...
void estimate_params(xt::xarray<double> X, xt::xarray<double>& mu,
...
ulong_tensor confusion_matrix(ulong_tensor y_true, ulong_tensor y_pred,
                              int nclasses) {
...
double_tensor calc_classifcation_metrics(ulong_tensor y_true,
                                         ulong_tensor y_pred, int nclasses) {
